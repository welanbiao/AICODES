...
window.ZC_SCENES = [
  {
    ...
    choices: [
      ...
      { text: "点头应声。", aff: 2, next: "hint_phone", note: "他问得生硬，但你还是答了", flags: { spoke: true }, judge: "doing" },
      { text: "低头看手机，不接话。", aff: -2, next: "hint_phone", note: "被冷脸盯着，只觉得莫名其妙", flags: { wary: true }, judge: "fail" }
    ]
  },
  {
    id: "hint_phone",
